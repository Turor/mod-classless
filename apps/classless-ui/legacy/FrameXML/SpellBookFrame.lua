...
function SpellBookFrame_OnLoad(self)
	...
	SPELLBOOK_PAGENUMBERS[30] = 1;
	SPELLBOOK_PAGENUMBERS[31] = 1;
	SPELLBOOK_PAGENUMBERS[32] = 1;
	SPELLBOOK_PAGENUMBERS[33] = 1;
	SPELLBOOK_PAGENUMBERS[34] = 1;
	SPELLBOOK_PAGENUMBERS[35] = 1;
	...
	SpellBook_SkillTabOverFlowButton:SetPoint("TOPLEFT", SpellBookSkillLineTab1, 0, 35)

	SpellBook_SkillTabOverFlowButton:SetNormalTexture("Interface\\Buttons\\UI-SpellbookIcon-NextPage-Up")
	SpellBook_SkillTabOverFlowButton:SetPushedTexture("Interface\\Buttons\\UI-SpellbookIcon-NextPage-Down")
	SpellBook_SkillTabOverFlowButton:SetDisabledTexture("Interface\\Buttons\\UI-SpellbookIcon-NextPage-Disabled")
    SpellBook_SkillTabOverFlowButton:SetHighlightTexture("Interface\\Buttons\\UI-Common-MouseHilight", "ADD")
	...
	SpellBook_SkillTabOverFlowButton_b:SetPoint("BOTTOMLEFT", SpellBookSkillLineTab7, 0, -38)
	SpellBook_SkillTabOverFlowButton_b:SetNormalTexture("Interface\\Buttons\\UI-SpellbookIcon-PrevPage-Up")
    SpellBook_SkillTabOverFlowButton_b:SetPushedTexture("Interface\\Buttons\\UI-SpellbookIcon-PrevPage-Down")
    SpellBook_SkillTabOverFlowButton_b:SetDisabledTexture("Interface\\Buttons\\UI-SpellbookIcon-PrevPage-Disabled")
    SpellBook_SkillTabOverFlowButton_b:SetHighlightTexture("Interface\\Buttons\\UI-Common-MouseHilight", "ADD")
...
--   if numSkillLineTabs <= pagemax then
--       _G[SpellBook_SkillTabOverFlowButton]:Hide();
--     -- hide next button
--   elseif numSkilLLineTabs > pagemax then
--       _G[SpellBook_SkillTabOverFlowButton]:Show();
--     -- show next button
--   end
--
--   if skilltab_pagenum == 1 then
--       _G[SpellBook_SkillTabOverFlowButton_b]:Hide();
